...
@IonicPage()
@Component({
  selector: "box-office-movies",
  templateUrl: "box-office-movies.html",
  providers: [TmdbProvider]
})
export class BoxOfficeMoviesPage {
  rootNavCtrl: any;
  ...
  ionViewDidLoad() {
    console.log("ionViewDidLoad BoxOfficeMoviesPage");
  }
  ...
  getBoxOfficeMovies(page: number): Promise<any> {
    return new Promise(resolve => {
      this.tmdbProvider.getBoxOfficeMovies(page).subscribe(result => {
        result.forEach(x => {
